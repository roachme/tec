...
struct help helptab[] = {
    ...
    \n\
    If no task ID is passed then task ID is generated. Every time increasing\n\
    task ID. Examples of generated task IDs are shown below.\n\
    Generated task IDs: 00000000, 00000001, etc\n\
    \n\
    Exit status:\n\
    The return code is zero, unless invalid option or argument is given,\n\
    task ID already exists or hook failed to execute.\n"},
    {
     .tag = TAGBASIC,
     .name = "cat",
    ...
    hook failed to execute or unit file is corrupted.\n"},
    {
     .tag = TAGBASIC,
     .name = "cd",
    ...
    Exit status:\n\
    The return code is zero, unless invalid option or argument is given,\n\
    destination task ID already exist or hook failed to execute.\n"},
    {
     .tag = TAGBASIC,
     .name = "rm",
    ...
    Exit status:\n\
    The return code is zero, unless invalid option or argument is given,\n\
    task ID does not exist or hook failed to execute.\n"},
    {
     .tag = TAGBASIC,
     .name = "set",
    ...
    Exit status:\n\
    The return code is zero, unless invalid option or argument is given,\n\
    desk name already exists or hook failed to execute.\n"},
    {
     .tag = TAGOBJCMD,
     .name = "desk-ls",
    ...
    \n\
    Exit status:\n\
    The return code is zero, unless invalid option or argument,\n\
    environment name is given or hook failed to execute.\n"},
    {
     .tag = TAGOBJCMD,
     .name = "desk-mv",
    ...
    Exit status:\n\
    The return code is zero, unless invalid option or argument is given,\n\
    destination desk name already exist or hook failed to execute.\n"},
    {
     .tag = TAGOBJCMD,
     .name = "desk-rm",
    ...
    Exit status:\n\
    The return code is zero, unless invalid option or argument is given,\n\
    desk name does not exist or hook failed to execute.\n"},
    {
     .tag = TAGOBJCMD,
     .name = "desk-set",
    ...
    Exit status:\n\
    The return code is zero, unless invalid option or argument is given,\n\
    environment name already exists or hook failed to execute.\n"},
    {
     .tag = TAGOBJCMD,
     .name = "env-cat",
    ...
    Exit status:\n\
    The return code is zero, unless invalid option or argument is given,\n\
    destination environment name already exist or hook failed to execute.\n"},
    {
     .tag = TAGOBJCMD,
     .name = "env-rm",
    ...
    Exit status:\n\
    The return code is zero, unless invalid option or argument is given,\n\
    environment name does not exist or hook failed to execute.\n"},
    {
     .tag = TAGOBJCMD,
     .name = "env-set",
