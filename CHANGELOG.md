...
- `cli/add`: Add option for verbose output
...
- `tests`: Add valgrind memory leak tests
...
- `cli/env`: Rename command `env` subcommand `show` to `cat`
- `cli/desk`: Rename command `desk` subcommand `move` to `mv`
